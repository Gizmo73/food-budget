...
{"store": string|null, "date": string|null, "lines": [{"name": string, "unitPrice": number, "qty": number, "offer": boolean}]}
...
- offer is true when that line was charged at a loyalty price (Clubcard, Nectar and so on), a multibuy, or any other promotion. Look for markers next to the line or a matching saving further down the receipt. Otherwise offer is false.
- Where a promotion applied, unitPrice is the amount actually charged, not the shelf price.
